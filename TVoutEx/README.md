# This library is modified version of Arduino TVout

Changes include:
	* Add blinking cursor
	* Option to use static buffer instead of heap to avoid link "malloc" and "free" functions
	* TVoutPrint class for printing a text, supporting some vt100 commands
